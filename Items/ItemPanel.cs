...
{   
    public partial class ItemPanel : UserControl
    {
        ...
        public Item KokiriBoots = new() { ItemPicture = (Bitmap)Image.FromFile("Textures/N64/Kokiri_Boots_N64.png"), State = 0, MaxCount = 1, MinCount = 0, ItemPicture_bw = (Bitmap)Image.FromFile("Textures/N64/Kokiri_Boots_N64_bw.png"), Item_Name = "." };
        ...
        public Item KokiriTunic = new() { ItemPicture = (Bitmap)Image.FromFile("Textures/N64/Kokiri_Tunic_N64.png"), State = 0, MaxCount = 1, MinCount = 0, ItemPicture_bw = (Bitmap)Image.FromFile("Textures/N64/Kokiri_Tunic_N64_bw.png"), Item_Name = "." };
        ...
        public Item Agony = new() { ItemPicture = (Bitmap)Image.FromFile("Textures/N64/Stone_of_Agony_N64.png"), State = 0, MaxCount = 1, MinCount = 0, ItemPicture_bw = (Bitmap)Image.FromFile("Textures/N64/Stone_of_Agony_N64_bw.png"), Item_Name = "." };
        public Item DoubleDefense = new() { ItemPicture = Resources.OoT3D_Heart_Container_Icon, State = 0, MaxCount = 1, MinCount = 0, ItemPicture_bw = Resources.OoT3D_Heart_Container_Icon_bw, Item_Name = "." };
