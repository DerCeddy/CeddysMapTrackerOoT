...
namespace CeddyMapTracker
{
    ...
    public partial class Maptracker
    {
        ...
        public Region_Panel_Check GCPotFreestandingPoH = new("Pot Freestanding PoH") { CheckIndex = 68 };
        ...
        public Region_Panel_Check GCMazeLeftChest = new("Maze Left Chest") { CheckIndex = 69 };
        ...
        public Region_Panel_Check ToTShiek = new("Song from Shiek") { CheckIndex = 75 };
        ...
        public Region_Panel_Check BotWInvisibleChest = new("Invisible Chest") { CheckIndex = 135};
        public Region_Panel_Check BotWLensofTruthChest = new("Lens of Truth Chest") { IsBoss = true, CheckIndex = 136 };
        ...
        public Region_Panel_Check FireFlareDancerChest = new("Flare Dancer Chest") { CheckIndex = 137};
        public Region_Panel_Check FireBossKeyChest = new("Boss Key Chest") { CheckIndex = 138 };
        ...
        public Region_Panel_Check WaterBossKeyChest = new("Boss Key Chest") { CheckIndex = 71 };
        ...
        public Region_Panel_Check ShadowInvisibleBladesVisibleChest = new("Invisible Blades Visible Chest") { CheckIndex = 141 };
        public Region_Panel_Check ShadowInvisibleBladesInvisibleChest = new("Invisible Blades Invisible Chest") { CheckIndex = 142 };
        ...
        public Region_Panel_Check ShadowFreestandingKey = new("Freestanding Key") { CheckIndex = 73 };
        ...
        public Region_Panel_Check ShadowSpikeWallsLeftChest = new("Spike Walls Left Chest") { CheckIndex = 143 };
        public Region_Panel_Check ShadowBossKeyChest = new("Boss Key Chest") { CheckIndex = 144 };
        ...
        public Region_Panel_Check SpiritChildBridgeChest = new("Child Bridge Chest") { CheckIndex = 145 };
        public Region_Panel_Check SpiritChildEarlyTorchesChest = new("Child Early Torches Chest") { CheckIndex = 146 };
        ...
        public Region_Panel_Check SpiritCompassChest = new("Compass Chest") { CheckIndex = 149 };
        public Region_Panel_Check SpiritEarlyAdultRightChest = new("Early Adult Right Chest") { CheckIndex = 150 };
        ...
        public Region_Panel_Check IceCavernShiek = new("Song from Shiek") { CheckIndex = 7, IsBoss = true };
        ...
        public Region_Panel_Check GTGMazePathFinalChest = new("Maze Path Final Chest") { IsBoss = true };
        ...
        public Region_Panel_Check GanonsCastleShadowTrialGoldenGauntletsChest = new("Shadow Trial Golden Gauntlets Chest") { CheckIndex = 72 };
        ...
        public Region_Panel_Check GanonsCastleSpiritTrialCrystalSwitchChest = new("Spirit Trial Crystal Switch Chest") { CheckIndex = 139 };
        public Region_Panel_Check GanonsCastleSpiritTrialInvisibleChest = new("Spirit Trial Invisible Chest") { CheckIndex = 140 };
