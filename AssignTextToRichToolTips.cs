...
namespace CeddyMapTracker
{
    public partial class Form1 : Form
    {
        public void AssignTextToRichToolTips()
        {
            ...
            MapTracker.Deku_Button.RichToolTip.CheckName = "Deku Tree Entrance";
            MapTracker.DC_Button.RichToolTip.CheckName = "Dodongo's Cavern Entrance";
            MapTracker.Jabu_Button.RichToolTip.CheckName = "Jabu-Jabu's Belly Entrance";
            MapTracker.BotW_Button.RichToolTip.CheckName = "Bottom of the Well Entrance";
            MapTracker.Forest_Button.RichToolTip.CheckName = "Forest Temple Entrance";
            MapTracker.Fire_Button.RichToolTip.CheckName = "Fire Temple Entrance";
            MapTracker.Water_Button.RichToolTip.CheckName = "Water Temple Entrance";
            MapTracker.Shadow_Button.RichToolTip.CheckName = "Shadow Temple Entrance";
            MapTracker.Spirit_Button.RichToolTip.CheckName = "Spirit Temple Entrance";
            MapTracker.GTG_Button.RichToolTip.CheckName = "Gerudo Training Grounds Entrance";
            MapTracker.Ice_Button.RichToolTip.CheckName = "Ice Cavern Entrance";
            MapTracker.GanonsCastle_Button.RichToolTip.CheckName = "Ganon's Castle";
            MapTracker.GanonsCastle_Button.RichToolTip.CheckLogic = "";
            ...
            //DMC
            MapTracker.DMCShiek.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.Bolero.Item_Name} or (({ItemPanel.Bomb.Item_Name} or {ItemPanel.Strength.Item_Name} or {ItemPanel.Bow.Item_Name}) and ({ItemPanel.Hookshot.Item_Name} or {ItemPanel.HoverBoots.Item_Name})) or ({ItemPanel.Hammer.Item_Name} and {ItemPanel.HoverBoots.Item_Name})";
            ...
            //Deku Tree
            MapTracker.Deku_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.KokiriSword.Item_Name}";
            MapTracker.DekuTreeMapChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.DekuTreeSlingshotRoomSideChest.RichToolTip.CheckLogic = $"• {ItemPanel.DekuShield.Item_Name} or {ItemPanel.HylianShield.Item_Name}";
            MapTracker.DekuTreeSlingshotChest.RichToolTip.CheckLogic = $"• {ItemPanel.DekuShield.Item_Name} or {ItemPanel.HylianShield.Item_Name}";
            MapTracker.DekuTreeCompassChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.DekuTreeCompassRoomSideChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.DekuTreeBasementChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.DekuTreeQueenGohmaHeart.RichToolTip.CheckLogic = $"• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Bow.Item_Name} or ({ItemPanel.Dins.Item_Name} and {ItemPanel.Magic.Item_Name})\r\n• {ItemPanel.DekuShield.Item_Name} or {ItemPanel.HylianShield.Item_Name}";
            //Dodongos Cavern
            MapTracker.DC_Button.RichToolTip.CheckLogic = $"\r\nChild\r\n• {ItemPanel.Strength.Item_Name} or {ItemPanel.Bomb.Item_Name}\r\nAdult\r\n• Nothing";
            ...
            // Jabu Jabus Belly
            MapTracker.Jabu_Button.RichToolTip.CheckLogic = $"\r\n• ({ItemPanel.Bomb.Item_Name} and {ItemPanel.ZeldasLullaby.Item_Name}) or {ItemPanel.Scales.Item_Name}\r\n• {ItemPanel.RutoLetter.Item_Name}";
            MapTracker.JabuJabusBellyBoomerangChest.RichToolTip.CheckLogic = $"• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name} or {ItemPanel.Bomb.Item_Name}";
            MapTracker.JabuJabusBellyCompassChest.RichToolTip.CheckLogic = $"• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name} or {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Boomerang.Item_Name}";
            MapTracker.JabuJabusBellyMapChest.RichToolTip.CheckLogic = $"• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name} or {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Boomerang.Item_Name}";
            MapTracker.JabuJabusBellyBarinadeHeart.RichToolTip.CheckLogic = $"• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name} or {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Boomerang.Item_Name}";
            //Forest Temple
            MapTracker.Forest_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.SariasSong.Item_Name} or {ItemPanel.Minuet.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}";
            MapTracker.ForestFirstRoomChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.ForestFirstStalfosRoomChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.ForestRaisedIslandCourtyardChest.RichToolTip.CheckLogic = $"• (({ItemPanel.Bow.Item_Name} or {ItemPanel.SongOfTime.Item_Name}) and {ItemPanel.Hookshot.Item_Name}) or {DungeonInfo.ForestTemple.KeyCount5}";
            MapTracker.ForestMapChest.RichToolTip.CheckLogic = $"• {ItemPanel.SongOfTime.Item_Name} or ({ItemPanel.Bow.Item_Name} and {ItemPanel.Hookshot.Item_Name})";
            MapTracker.ForestWellChest.RichToolTip.CheckLogic = $"• {ItemPanel.SongOfTime.Item_Name} or ({ItemPanel.Bow.Item_Name} and {ItemPanel.Hookshot.Item_Name})";
            MapTracker.ForestEyeSwitchChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount1}";
            MapTracker.ForestBossKeyChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount2}";
            MapTracker.ForestFloormasterChest.RichToolTip.CheckLogic = $"• ({ItemPanel.Bow.Item_Name} and {ItemPanel.Strength.Item_Name} and {DungeonInfo.ForestTemple.KeyCount2}) or ({ItemPanel.HoverBoots.Item_Name} and {DungeonInfo.ForestTemple.KeyCount1})";
            MapTracker.ForestRedPoeChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount3}";
            MapTracker.ForestBowChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount3}";
            MapTracker.ForestBluePoeChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount3}";
            MapTracker.ForestFallingCeillingRoomChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount5}";
            MapTracker.ForestBasementChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount5}";
            MapTracker.ForestPhantomGanonHeart.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ForestTemple.KeyCount5}\r\n• {DungeonInfo.ForestBossKey.Item_Name}";
            //Fire Temple
            MapTracker.Fire_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.Bolero.Item_Name} or (({ItemPanel.Bomb.Item_Name} or {ItemPanel.Strength.Item_Name} or {ItemPanel.Bow.Item_Name}) and ({ItemPanel.Hookshot.Item_Name} or {ItemPanel.HoverBoots.Item_Name})) or ({ItemPanel.Hammer.Item_Name} and {ItemPanel.HoverBoots.Item_Name})";
            MapTracker.FireNearBossChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.FireFlareDancerChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hammer.Item_Name}";
            MapTracker.FireBossKeyChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hammer.Item_Name}";
            MapTracker.FireBigLavaRoomLowerDoorChest.RichToolTip.CheckLogic = $"• {DungeonInfo.FireTemple.KeyCount1}";
            MapTracker.FireBigLavaRoomBlockedDoorChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount1}";
            MapTracker.FireBoulderMazeLowerChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount3}";
            MapTracker.FireBoulderMazeSideRoomChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount3}";
            MapTracker.FireMapChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• ({DungeonInfo.FireTemple.KeyCount4} and {ItemPanel.Bow.Item_Name}) or {DungeonInfo.FireTemple.KeyCount5}";
            MapTracker.FireBoulderMazeShortcutChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount5}";
            MapTracker.FireBoulderMazeUpperChest.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount5} ";
            MapTracker.FireScarecrowChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount5}";
            MapTracker.FireCompassChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {DungeonInfo.FireTemple.KeyCount6}";
            MapTracker.FireMegatonHammerChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• ({DungeonInfo.FireTemple.KeyCount6} and {ItemPanel.HoverBoots.Item_Name} and {ItemPanel.Hammer.Item_Name}) or {DungeonInfo.FireTemple.KeyCount7} ";
            MapTracker.FireHighestGoronChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name}\r\n• {ItemPanel.Hammer.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• ({DungeonInfo.FireTemple.KeyCount6} and {ItemPanel.HoverBoots.Item_Name}) or ({DungeonInfo.FireTemple.KeyCount7} and ({ItemPanel.Bomb.Item_Name} or {ItemPanel.SongOfTime.Item_Name}))";
            MapTracker.FireVolvagiaHeart.RichToolTip.CheckLogic = $"• {ItemPanel.Hammer.Item_Name}\r\n• {ItemPanel.Wallet.Item_Name} or {ItemPanel.GoronTunic.Item_Name}\r\n• {ItemPanel.HoverBoots.Item_Name} or ({DungeonInfo.FireTemple.KeyCount7} and ({ItemPanel.Bomb.Item_Name} or {ItemPanel.SongOfTime.Item_Name}))\r\n• {DungeonInfo.FireBossKey.Item_Name}";
            //Water Temple
            MapTracker.Water_Button.RichToolTip.CheckLogic = $"\r\n• ({ItemPanel.Hookshot.Item_Name} and {ItemPanel.IronBoots.Item_Name}) or ({ItemPanel.Hookshot.Item_Name1} and {ItemPanel.Scales.Item_Name1})";
            MapTracker.WaterCompassChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.IronBoots.Item_Name} or {ItemPanel.ZeldasLullaby.Item_Name}";
            MapTracker.WaterMapChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name} or {ItemPanel.Bow.Item_Name} or {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.IronBoots.Item_Name}";
            MapTracker.WaterCrackedWallChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name} or {ItemPanel.Bow.Item_Name} or {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.IronBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Bow.Item_Name} or ({ItemPanel.Dins.Item_Name} and {ItemPanel.Magic.Item_Name}) or ({DungeonInfo.WaterTemple.KeyCount5} and {ItemPanel.Hookshot.Item_Name})";
            MapTracker.WaterTorchesChest.RichToolTip.CheckLogic = $"• {ItemPanel.IronBoots.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Bow.Item_Name} or ({ItemPanel.Dins.Item_Name} and {ItemPanel.Magic.Item_Name})";
            ...
            //Shadow Temple
            MapTracker.Shadow_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.Nocturne.Item_Name}\r\n• {ItemPanel.Dins.Item_Name}\r\n• {ItemPanel.Magic.Item_Name}";
            MapTracker.ShadowMapChest.RichToolTip.CheckLogic = $"{ItemPanel.Hookshot.Item_Name} or {ItemPanel.HoverBoots.Item_Name}";
            MapTracker.ShadowHoverBootsChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name} or {ItemPanel.HoverBoots.Item_Name}";
            MapTracker.ShadowCompassChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}";
            MapTracker.ShadowEarlySilverRupeeChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}";
            MapTracker.ShadowInvisibleBladesVisibleChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount1}";
            MapTracker.ShadowInvisibleBladesInvisibleChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount1}";
            MapTracker.ShadowFallingSpikesLowerChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount1}";
            MapTracker.ShadowFallingSpikesUpperChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount1}";
            MapTracker.ShadowFallingSpikesSwitchChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Strength.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount1}";
            MapTracker.ShadowInvisibleSpikesChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount2}";
            MapTracker.ShadowFreestandingKey.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount2}";
            MapTracker.ShadowWindHintChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount3}";
            MapTracker.ShadowAfterWindEnemyChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount3}";
            MapTracker.ShadowAfterWindHiddenChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount3}";
            MapTracker.ShadowSpikeWallsLeftChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Dins.Item_Name}\r\n• {ItemPanel.Magic.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount4}";
            MapTracker.ShadowBossKeyChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Dins.Item_Name}\r\n• {ItemPanel.Magic.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount4}";
            MapTracker.ShadowInvisibleFloormasterChest.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {DungeonInfo.ShadowTemple.KeyCount4}";
            MapTracker.ShadowBongoBongoHeart.RichToolTip.CheckLogic = $"• {ItemPanel.HoverBoots.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Bow.Item_Name} or {ItemPanel.Hookshot.Item_Name1}\r\n• {DungeonInfo.ShadowTemple.KeyCount5}\r\n• {DungeonInfo.ShadowBossKey.Item_Name}";
            // Spirit Temple
            MapTracker.Spirit_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.Reqiuem.Item_Name} or ((({ItemPanel.EponasSong.Item_Name} and {ItemPanel.HoverBoots.Item_Name}) or {ItemPanel.Hookshot.Item_Name1}) and {ItemPanel.Magic.Item_Name} and {ItemPanel.Lens.Item_Name})";
            MapTracker.SpiritChildBridgeChest.RichToolTip.CheckLogic = $"• Dungeon Access as Child\r\n• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name}";
            MapTracker.SpiritChildEarlyTorchesChest.RichToolTip.CheckLogic = $"• Dungeon Access as Child\r\n• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name}";
            MapTracker.SpiritChildClimbNorthChest.RichToolTip.CheckLogic = $"Child route\r\n• Dungeon Access as Child\r\n• {DungeonInfo.SpiritTemple.KeyCount5}\r\n• {ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name}\r\nAdult route\r\n• {ItemPanel.Strength.Item_Name1}\r\n• {DungeonInfo.SpiritTemple.KeyCount3}\r\n• {ItemPanel.Hookshot.Item_Name} or {ItemPanel.Bow.Item_Name}\r\nAge unknown route\r\n• (({ItemPanel.Slingshot.Item_Name} or {ItemPanel.Boomerang.Item_Name}) and ({ItemPanel.Hookshot.Item_Name} or {ItemPanel.Bow.Item_Name})) or {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount1}";
            ...
            MapTracker.SpiritCompassChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}";
            MapTracker.SpiritEarlyAdultRightChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}";
            MapTracker.SpiritFirstMirrorLeftChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {DungeonInfo.SpiritTemple.KeyCount3}";
            MapTracker.SpiritFirstMirrorRightChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {DungeonInfo.SpiritTemple.KeyCount3}";
            MapTracker.SpiritStatueRoomNortheastChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount3}";
            MapTracker.SpiritStatueRoomHandChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount3}";
            MapTracker.SpiritNearFourArmosChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.MirrorShield.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount4}";
            MapTracker.SpiritHallwayLeftInvisibleChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount4}";
            MapTracker.SpiritHallwayRightInvisibleChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount4}";
            MapTracker.SpiritMirrorShieldChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount4}";
            MapTracker.SpiritBossKeyChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Bow.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount5}";
            MapTracker.SpiritTopmostChest.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.MirrorShield.Item_Name}\r\n• {ItemPanel.Hookshot.Item_Name} or {ItemPanel.Bow.Item_Name} or {ItemPanel.Hammer.Item_Name} or {ItemPanel.Bomb.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount5}";
            MapTracker.SpiritTwinrovaHeart.RichToolTip.CheckLogic = $"• {ItemPanel.Strength.Item_Name1}\r\n• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name}\r\n• {ItemPanel.MirrorShield.Item_Name}\r\n• {DungeonInfo.SpiritTemple.KeyCount5}\r\n• {DungeonInfo.SpiritBossKey.Item_Name}";
            //GTG
            MapTracker.GTG_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.EponasSong.Item_Name} or {ItemPanel.Hookshot.Item_Name1}\r\n• {ItemPanel.GerudoCard.Item_Name}";
            MapTracker.GTGLobbyLeftChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name} or {ItemPanel.Slingshot.Item_Name}";
            MapTracker.GTGLobbyRightChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bow.Item_Name} or {ItemPanel.Slingshot.Item_Name}";
            MapTracker.GTGStalfosChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.GTGBeforeHeavyBlockChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}";
            MapTracker.GTGHeavyBlockFirstChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Strength.Item_Name1}";
            MapTracker.GTGHeavyBlockSecondChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Strength.Item_Name1}";
            MapTracker.GTGHeavyBlockThirdChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Strength.Item_Name1}";
            MapTracker.GTGHeavyBlockFourthChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Strength.Item_Name1}";
            MapTracker.GTGEyeStatueChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Bow.Item_Name}";
            MapTracker.GTGNearScarecrowChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Bow.Item_Name}";
            MapTracker.GTGHammerRoomClearChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}";
            MapTracker.GTGHammerRoomSwitchChest.RichToolTip.CheckLogic = $"• {ItemPanel.Hookshot.Item_Name}\r\n• {ItemPanel.Hammer.Item_Name}";
            MapTracker.GTGFreestandingKey.RichToolTip.CheckLogic = $"•(({ItemPanel.Bomb.Item_Name} or {ItemPanel.Hookshot.Item_Name}) and {ItemPanel.SongOfTime.Item_Name}) or {DungeonInfo.GTG.KeyCount9}";
            MapTracker.GTGMazeRightCentralChest.RichToolTip.CheckLogic = $"•(({ItemPanel.Bomb.Item_Name} or {ItemPanel.Hookshot.Item_Name}) and {ItemPanel.SongOfTime.Item_Name}) or {DungeonInfo.GTG.KeyCount9}";
            MapTracker.GTGMazeRightSideChest.RichToolTip.CheckLogic = $"•(({ItemPanel.Bomb.Item_Name} or {ItemPanel.Hookshot.Item_Name}) and {ItemPanel.SongOfTime.Item_Name}) or {DungeonInfo.GTG.KeyCount9}";
            MapTracker.GTGUnderwaterSilverRupeeChest.RichToolTip.CheckLogic = $"• {ItemPanel.SongOfTime.Item_Name}\r\n• {ItemPanel.IronBoots.Item_Name}";
            MapTracker.GTGBeamosChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bomb.Item_Name}";
            MapTracker.GTGHiddenCeilingChest.RichToolTip.CheckLogic = $"• {DungeonInfo.GTG.KeyCount3}";
            MapTracker.GTGMazePathFirstChest.RichToolTip.CheckLogic = $"• {DungeonInfo.GTG.KeyCount4}";
            MapTracker.GTGMazePathSecondChest.RichToolTip.CheckLogic = $"• {DungeonInfo.GTG.KeyCount6}";
            MapTracker.GTGMazePathThirdChest.RichToolTip.CheckLogic = $"• {DungeonInfo.GTG.KeyCount7}";
            MapTracker.GTGMazePathFinalChest.RichToolTip.CheckLogic = $"• {DungeonInfo.GTG.KeyCount9}";
            //BotW
            MapTracker.BotW_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.SongOfStorms.Item_Name}";
            MapTracker.BotWFrontLeftFakeWallChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.BotWFrontCenterBombableChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bomb.Item_Name}";
            MapTracker.BotWBackLeftBombableChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bomb.Item_Name}";
            MapTracker.BotWUnderwaterLeftChest.RichToolTip.CheckLogic = $"• {ItemPanel.ZeldasLullaby.Item_Name}";
            MapTracker.BotWFreestandingKey.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.BotWCompassChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.BotWCenterSkulltulaChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.BotWRightBottomFakeWallChest.RichToolTip.CheckLogic = $"• Nothing";
            MapTracker.BotWFireKeeseChest.RichToolTip.CheckLogic = $"• {DungeonInfo.BotW.KeyCount3}";
            MapTracker.BotWLikeLikeChest.RichToolTip.CheckLogic = $"• {DungeonInfo.BotW.KeyCount3}";
            MapTracker.BotWMapChest.RichToolTip.CheckLogic = $"• {ItemPanel.Bomb.Item_Name} or ({ItemPanel.Strength.Item_Name} and ({DungeonInfo.BotW.KeyCount3} or ({ItemPanel.Dins.Item_Name} and {ItemPanel.Magic.Item_Name})))";
            MapTracker.BotWUnderwaterFrontChest.RichToolTip.CheckLogic = $"• {ItemPanel.ZeldasLullaby.Item_Name}";
            MapTracker.BotWInvisibleChest.RichToolTip.CheckLogic = $"• {ItemPanel.ZeldasLullaby.Item_Name}";
            MapTracker.BotWLensofTruthChest.RichToolTip.CheckLogic = $"• {ItemPanel.ZeldasLullaby.Item_Name}";
            //Ice Cavern
            MapTracker.Ice_Button.RichToolTip.CheckLogic = $"\r\n• {ItemPanel.RutoLetter.Item_Name}\r\n• {ItemPanel.ZeldasLullaby.Item_Name}\r\n• {ItemPanel.Bomb.Item_Name} or {ItemPanel.Scales.Item_Name}";
